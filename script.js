...
function refugiada(){
  location.replace("Cadastro_refugiada.html")
}
function Entrar(){
...
alert("A tela a seguir está em construção. Mas quando for feita, após confirmação dos dados, você seguirá para a tela do site em que você consiga ver suas informações.")
  ;}
function doar() {
alert("A tela a seguir está em construção. Mas quando for feita irá aparecer uma tela informando sobre as formas de doação.")
  ;}
function sobre() {
